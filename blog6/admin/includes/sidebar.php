                            ...
                            <ul class="nav flex-column pe-3">
                                ...
                                <li class="nav-item">
                                    <a
                                        ...
                                        href="/blog6/admin/pages/categories/index.php"
                                    >
                                        <i
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2"
                                        href="/blog6/admin/pages/posts/index.php"
                                    >
                                        <i
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2"
                                        href="/blog6/admin/pages/comments/index.php"
                                    >
                                        <i
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2"
                                        href="/blog6/admin/pages/auth/logout.php"
                                    >
                                        <i
